...
//   }
//
//   // Update personalDetails and medications separately
...
exports.updateEmployee = catchAsyncErrors(async (req, res, next) => {
  ...
  employee.personalDetails = { ...employee.personalDetails, ...req.body.personalDetails };
  employee.medications = { ...employee.medications, ...req.body.medications };
